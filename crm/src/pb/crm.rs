...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_user_by_id(
            ...
            let path = http::uri::PathAndQuery::from_static("/crm.UserService/GetUserById");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("crm.UserService", "GetUserById"));
...
pub mod user_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/crm.UserService/GetUserById" => {
                    #[allow(non_camel_case_types)]
                    struct GetUserByIdSvc<T: UserService>(pub Arc<T>);
                    impl<T: UserService> tonic::server::UnaryService<super::GetUserRequest> for GetUserByIdSvc<T> {
